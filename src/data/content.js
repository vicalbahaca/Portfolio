...
export const caseStudies = [
  ...
  },
  {
    ...
    industry: 'Cloud Computing, Industry 4.0, Digital Transformation, and Sustainability',
  },
  {
    slug: 'closy',
    title: 'Closy',
...
const workDetailContent = {
  ...
  lowerton: {
    headline: 'Optimize digital transformation and sustainability with AI, and connect with global startups and consultancies.',
    facts: [
      { label: 'Tipo', value: 'Spin-off project developed for Lowerton, a startup specializing in innovation management' },
      { label: 'Rol', value: 'UX/UI & Product Designer' },
      { label: 'Industria', value: 'Cloud Computing, Industry 4.0, Digital Transformation, and Sustainability' },
    ],
    highlights: ['Centralized Ideation System', 'Solutions Scouting', 'Project Management'],
    visualDeck: [
      {
    ...
    detailSections: [
      {
        title: 'The Challenge',
        paragraphs: [
          'Many companies, especially SMEs, face growing pressure to innovate but struggle with high consulting costs and inefficient processes. Large enterprises often deal with redundancies and delays in managing innovation, while smaller businesses lack the tools to compete at the same level.',
          'The challenge was clear: businesses needed a way to centralize and automate their innovation management, reducing costs and increasing efficiency.',
        ],
      },
      {
        title: 'The Solution',
        paragraphs: [
          'Lowerton was created as an AI-powered innovation platform that helps businesses of all sizes streamline their entire innovation process.',
          'The product centralizes everything from business need identification to solution sourcing and project management. By leveraging AI, Lowerton makes innovation management more accessible, cost-effective, and scalable.',
        ],
      },
      {
        title: 'Research',
        paragraphs: [
          'The research phase involved conducting several interviews with key stakeholders from both Spanish and international companies. These interviews were essential to understand the specific problems companies face in managing their innovation processes.',
          'We worked closely with decision-makers from large enterprises and potential clients to iterate on the concept and shape the MVP based on their feedback. This ongoing process allowed us to refine our approach and ensure the platform addressed real-world challenges.',
        ],
      },
      {
        title: 'Research Results',
        body:
          'Three core feature areas became the foundation of the first roadmap and guided the low-fidelity wireframes used to visualize the interface.',
        points: [
          'A portal where employees and stakeholders can propose ideas and vote for the most relevant ones.',
          'A tool to search for startups and technology solutions that align with business needs on a self-driven basis.',
          'A centralized dashboard to monitor innovation initiatives, documents, customers, and project stages in one place.',
          'These features formed the initial development roadmap and gave structure to the first wireframes.',
        ],
      },
      {
        title: 'User Flows',
        paragraphs: [
          'Before starting the prototype creation, it was crucial to define clear user flows for the different roles within Lowerton, ensuring that nothing would be overlooked during the design phase.',
          'The user flows ensured that each role could easily navigate the platform, access relevant features, and perform tasks efficiently while maintaining a seamless and intuitive experience.',
          'These flows allowed us to structure the platform in a way that made it intuitive and efficient for all users, ensuring that each role had a seamless experience while navigating Lowerton’s key features.',
        ],
        points: [
          'Innovation Managers: Create and track innovation projects, set KPIs, and manage vendor relationships.',
          'Vendors: Submit proposals, respond to RFPs, and monitor project status.',
          'Reviewers: Evaluate ideas and proposals, and provide feedback based on set criteria.',
        ],
        gallery: [
          {
            src: 'https://framerusercontent.com/images/zuGk5HeaRl8PSr809ZzlX2Xplk.png',
            alt: 'Lowerton challenge detail and team roles screen',
          },
          {
            src: 'https://framerusercontent.com/images/4GE6BJYIJFymCQmSqz6wR8nI.png',
            alt: 'Lowerton multi-step form for new business needs',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'This version of Lowerton is just the beginning. Future iterations are prepared to integrate more AI capabilities, machine learning, and collaborative tools that help companies not only manage innovation, but also anticipate market needs.',
          'Lowerton is more than a platform: it is a tool that empowers companies to lead innovation, remain competitive, and adapt quickly to technological changes.',
        ],
        points: [
          'Centralized dashboard: provides a real-time view of project progress, KPIs, and collaborations with startups and vendors.',
          'Automated idea evaluation: uses AI to assess ideas based on impact and feasibility, speeding up decision-making.',
          'Automated scouting: facilitates the search for technology solutions and vendors aligned with company needs.',
          'Business needs creation: enables employees to propose needs that can later become future projects.',
          'Project management: offers end-to-end handling from documentation to communication and contract signing.',
        ],
        gallery: [
          {
            src: 'https://framerusercontent.com/images/06fynBaxnHEC3hrFvb2NoYFR1o.png',
            alt: 'Lowerton overview dashboard inside a laptop frame',
            ratio: '16 / 10',
          },
        ],
      },
  ...
  vworld: {
    headline: 'The social network that transforms the digital landscape into a social game.',
    facts: [
      { label: 'Tipo', value: 'Spin-off application project' },
      { label: 'Overview', value: 'In response to the decline of BeReal, VWorld reignites global interest through daily challenges that connect users worldwide.' },
      { label: 'Rol', value: 'UX/UI & Product Designer' },
      { label: 'Herramientas', value: 'Figma, FigJam, Tally, Canva, Notion, Paper, and Pen' },
      { label: 'Duracion', value: 'Q1 2024' },
    ],
    highlights: ['Key Data from BeReal', 'Validation Data', 'Growth, Retention and Partnerships'],
    visualDeck: [
      {
        src: 'https://framerusercontent.com/images/JtVb0usDczVHMOTpwA3njiU.png?scale-down-to=1024',
        alt: 'VWorld splash screen on iPhone',
        ratio: '3 / 5',
      },
      {
        src: 'https://framerusercontent.com/images/aRe5ithZliEmF4plqvvhSCeUn9E.png',
        alt: 'VWorld logo evolution from BeReal references',
      },
      {
        src: 'https://framerusercontent.com/images/N10YunNzGZpaYoUD1LVjrG2SSg.png',
        alt: 'VWorld sitemap with feed, friends, challenge and profile architecture',
      },
    ],
    detailSections: [
      {
        title: 'Overview',
        paragraphs: [
          'In response to the decline of BeReal, VWorld emerges to reignite global interest, establishing a strong community through daily challenges that connect users worldwide.',
          'The concept reinvents online interactions by promoting a social game that redefines how people behave on social networks.',
        ],
      },
      {
        title: 'The Problem of BeReal',
        paragraphs: [
          'BeReal captured attention in 2022 by offering a genuine and spontaneous alternative in a digital world saturated with curated content. Its core mechanic, the absence of advertising, and its strong community focus drove it to 73.5 million active users in August 2022.',
          'However, since the beginning of 2023, the app has shown signs of stagnation and decline. Active users dropped to 18 million in one year, representing a 75.51% decrease from its peak.',
          'Several factors contributed to that decline, including the emergence of similar features in competitors like Instagram and TikTok, the lack of new features, and an unconsolidated business model.',
          'BeReal now faces a critical challenge: to adapt, innovate, and define a model that sustains its values of authenticity and community focus.',
        ],
      },
      {
        title: 'The Solution',
        tone: 'blue',
        paragraphs: [
          'VWorld was proposed as an innovative extension of BeReal, designed to inject fun and unity among users globally while amplifying authenticity with a playful, community-focused approach.',
          'The app turns each day into an adventure with random challenges that can be enjoyed individually or in groups, fostering a social avalanche that motivates more people to join.',
          'It invites participation in daily challenges and aims for the same kind of collective momentum that made experiences like Pokemon Go memorable at global scale.',
          'The name “VWorld” combines “versus” and “world”, reflecting its essence as a global challenge. It also opens a path for creators or brands with audiences to expand reach in new and different ways.',
      ...
      {
        title: 'Questionnaire + Validation',
        paragraphs: [
          'A questionnaire with essential questions for the app’s development was designed and distributed through Tally, selected for both its data visualization and ease of response.',
          'We collected 50 responses, with an average age of 25 years, creating a representative sample of the target audience.',
          'The survey validated the main idea of gamifying the BeReal experience and confirmed that keeping random notifications would encourage spontaneous participation in daily activities.',
        ],
        gallery: [
          {
            src: 'https://framerusercontent.com/images/F0lKqAnSNuqrETMAmLZCK5c.png',
            alt: 'VWorld validation chart with survey breakdown',
          },
        ],
      },
      {
      ...
      },
      {
        title: 'How Might We...?',
        paragraphs: [
          'From the beginning of the project, the central idea was to gamify BeReal to create a social avalanche while generating content and strengthening the community.',
      ...
      {
        title: 'Site Map and Task Flows',
        paragraphs: [
          'After a card sorting and feature ideation exercise, the site map was defined as the backbone of the app, organizing content and features into intuitive categories.',
          'This structure ensured that the experience remained smooth and natural, promoting organic and consistent interaction.',
          'Different task flows were then created, including the process of adding a friend and completing a challenge, to guarantee that all screens and steps were represented before moving to hi-fi.',
          'Those flows were critical to guide the user efficiently through each task and reduce friction in the most important loops of the app.',
        ],
        points: [
          'Friend-adding flow defined before visual design.',
          'Challenge-completion flow designed end to end.',
          'Information architecture built from both social-network benchmarks and user needs.',
        ],
        gallery: [
          {
            src: 'https://framerusercontent.com/images/N10YunNzGZpaYoUD1LVjrG2SSg.png',
            alt: 'VWorld sitemap created after card sorting and feature definition',
          },
        ],
      },
      {
        title: 'Prototyping',
        paragraphs: [
          'For the mood board, elements that evoke action and alertness were selected, using yellow and orange colors typical of warning signs. This differentiated the app from BeReal’s black-and-white baseline while keeping a familiar harmony.',
          'In typography, the decision was to keep Inter together with iOS native typography to ensure consistency and readability on Apple devices.',
          'Initially the app was not directly related to BeReal, but after deeper analysis it was decided to embrace BeReal’s branding language and simplicity for recognizability.',
          'The logo evolved directly from BeReal’s original logo, adding alert-like colors to communicate that both products belonged to the same family.',
          'The hi-fi wireframes focused on home and friends pages, staying close to BeReal while redesigning selected areas to improve the user experience and make adoption easier for existing users.',
          'Following BeReal’s model, the product was designed exclusively for mobile devices to take advantage of the immediacy required for challenges and feed behavior.',
        ],
        gallery: [
          {
            src: 'https://framerusercontent.com/images/JtVb0usDczVHMOTpwA3njiU.png?scale-down-to=1024',
            alt: 'VWorld splash screen prototype',
            ratio: '3 / 5',
          },
          {
            src: 'https://framerusercontent.com/images/aRe5ithZliEmF4plqvvhSCeUn9E.png',
      ...
      {
        title: 'Release and Marketing',
        paragraphs: [
          'To ensure the success of VWorld, as happened with BeReal, a significant investment in digital marketing and social media strategies would be essential, focused first on attracting new users and generating a domino effect.',
          'This time, communication would need to present the app in a more educational and engaging way, emphasizing that VWorld is less about superficial validation and more about creativity, authenticity, and going beyond the comfort zone.',
        ],
        points: [
          'Focus on word of mouth and invitations from current users.',
          'Collaborations with influencers whose personality resonates with the target audience.',
          'Paid and organic campaigns on Instagram and TikTok, plus email campaigns using existing user databases.',
          'Events and contests to reinforce community participation.',
          'Variety of challenges so both introverted and extroverted people can participate.',
          'Interactive features like chats for sharing challenges with friends.',
          'Recognition and rewards for active participation.',
          'Leaderboards to activate competitiveness and increase engagement.',
          'Brand partnerships to fund the product without relying on conventional advertising.',
        ],
      },
      {
        title: 'Feedback and Continuous Improvement',
        paragraphs: [
          'The post-launch layer was designed around constant listening and iteration, treating community feedback as part of the product system itself.',
        ],
        points: [
          'In-app surveys, group dynamics, and comment analysis in app stores.',
          'Active monitoring of feedback on social media where users share experiences and suggestions informally.',
          'A dedicated team for product improvement based on user suggestions.',
          'An online help center with answers to frequent questions and support.',
          'Re-engagement campaigns using email and push notifications for inactive users.',
        ],
      },
    ],
  },
  closy: {
    ...
    detailSections: [
      ...
      {
        title: 'Questionnaire and Key Insights',
        paragraphs: [
          'A questionnaire was distributed to young people in Spain and Latin America and received 150 responses. It was created with Tally because it combined attractive data visualization with an engaging answering experience.',
          'The results became key to both analysis and direction of the project.',
        ],
        points: [
          'These results confirm that most people suffer from loneliness.',
          'The findings support Robin Dunbar’s idea that people maintain a limited close circle, around five meaningful relationships.',
          'People often isolate themselves, which leads to difficulty maintaining long-term relationships.',
          'A significant majority tend to forget to respond to messages.',
      ...
      {
        title: 'Site Map, Task Flow and User Flow',
        paragraphs: [
          'Before shaping the interface, the project was organized like a manual: site map, task flow, user flow, and lo-fi wireframes.',
          'The site map clarified the organization of Closy’s features and established a logical, accessible structure where users could reach each function with as few clicks as possible.',
          'Task flows were used to define the exact path users would follow from the start to the end of an action, ensuring that all required screens existed before high-fidelity design started.',
          'The user flow then placed each feature in the right wireframe and helped keep the app organized and coherent from the beginning.',
          'Lo-fi wireframes began as a drawing marathon on paper and were later digitized in Figma to refine structure, size, and functionality before moving into detailed design.',
        ],
        points: [
          'Site map',
          'Task flow',
        ...
        gallery: [
          {
            ...
            alt: 'Closy flow map connecting onboarding, home, plants and challenges',
          },
        ],
      },
      {
        ...
        gallery: [
          {
            src: 'https://framerusercontent.com/images/8HkVugR3nnhibYl9YZd6M5pU6s4.png',
            alt: 'Closy brand assets and iconography exploration',
          },
          {
            src: 'https://framerusercontent.com/images/QKP0JMEajT4eVYZ8mYOMxsAoY.png',
            alt: 'Closy splash screen using the final identity',
            ratio: '3 / 5',
          },
          {
            src: 'https://framerusercontent.com/images/uJ7vEy14G4XPunq3e4x9YiSxXlQ.png',
            alt: 'Closy plant challenge interaction in the final prototype',
            ratio: '3 / 5',
          },
        ],
      },
